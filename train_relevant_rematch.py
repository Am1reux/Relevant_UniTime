...
from utils import (
    rank0_print, find_all_linear_names, safe_save_model_for_hf_trainer, TrainerWithCustomSampler,
)
...
def train():
    ...
    train_dataset = VideoCentricDataset(
    ...
    # data collator
    print(model_args.model_family_id)
    # data_collator = COLLATORS["qwen2-vl-relevant-mr"](
    #     config=config,
    #     tokenizer=tokenizer,
    #     processor=processor,
