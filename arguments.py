...
class DataArguments:
    ...
    fps: Optional[float] = field(default=2)
    retrieval_mode: Optional[str] = field(default="mr")
    num_clips: Optional[int] = field(default=32)
    clip_length: Optional[int] = field(default=-1)
